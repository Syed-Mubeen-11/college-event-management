...
function AdminLayout({ children }) {
  ...
  const menuItems = [
    ...
    { icon: FaCalendarAlt, label: 'Events', path: '/dashboard/admin/events' },
    { icon: FaUsers, label: 'Students', path: '/dashboard/admin/students' },
    { icon: FaChartBar, label: 'Reports', path: '/dashboard/admin/reports' },
    { icon: FaCertificate, label: 'Certificates', path: '/dashboard/admin/certificates' },
    { icon: FaUser, label: 'Profile', path: '/dashboard/admin/profile' }
  ]
            ...
            <div className="flex items-center gap-4 ml-auto">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="hidden md:block text-sm text-textSecondary">{user?.name?.split(' ')[0] || 'Admin'}</span>
                </button>
